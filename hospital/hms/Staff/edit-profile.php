...
$sql=mysqli_query($con,"Update staff set staffRole='$staffRole',staffName='$staffName',address='$address',salary='$salary',contactno='$contactno',staffEmail='$staffEmail' where id='$did'");
if($sql)
{
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><font face="Garamond" size="6px" >Admin | Edit Staff Details</font></h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
...
<hr />
							...
							<select name="staffRole" class="form-control" required="required">
					<option value="<?php echo htmlentities($data['staffRole']);?>">
					<?php echo htmlentities($data['staffRole']);?></option>
...
<div class="form-group">
		...
		<input type="text" name="salary" class="form-control" required="required"  value="<?php echo htmlentities($data['salary']);?>" >
														</div>
